...
mixin _$SignUpStates<T> {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is SignUpStates<T>);
  }
...
class Loading<T> implements SignUpStates<T> {
  Loading();
...
class Success<T> implements SignUpStates<T> {
  Success(this.data);
...
class Error<T> implements SignUpStates<T> {
  Error(this.message);
  ...
  @override
  String toString() {
    return 'SignUpStates<$T>.error(message: $message)';
  }
}
